...
selected_features = pd.read_csv('selected_features_15_r2_2013.txt')
...
f5 = open('svr_r2_result_5.txt','wb')
...
f5.write('\n')
f5.write('predict:')
f5.write(str(svr_model.predict(data2014[selected_features.name[0:5]])))
f5.write('\n')
f5.close()
...
f10 = open('svr_r2_result_10.txt','wb')
...
f10.write('\n')
f10.write('predict:')
f10.write(str(svr_model.predict(data2014[selected_features.name[0:10]])))
f10.write('\n')
f10.close()
